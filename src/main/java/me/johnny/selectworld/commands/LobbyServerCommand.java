...
public class LobbyServerCommand implements CommandExecutor {

    private final SelectWorld selectWorld;

    public LobbyServerCommand(SelectWorld selectWorld) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args) {
        ...
        SelectWorldUtil.attemptServerChange(selectWorld, SelectWorld.WorldTypes.LOBBY, pl);
        return true;
